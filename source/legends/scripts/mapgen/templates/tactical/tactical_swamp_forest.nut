this.tactical_swamp_forest <- this.inherit("scripts/mapgen/tactical_template", {
	m = {},
	function init()
	{
		this.m.Name = "tactical.swamp_forest";
		this.m.MinX = 32;
		this.m.MinY = 32;
	}
	...
	function fill( _rect, _properties, _pass = 1 )
	{
		...
		local tile4 = this.MapGen.get("tactical.tile.swampforest4");
		local tile5 = this.MapGen.get("tactical.tile.swampforest5");
		this.addRoads(_rect, _properties);
		local templates = [];
		local mainPatch = this.MapGen.get("tactical.patch.swamp_forest");
		local pondPatch = this.MapGen.get("tactical.patch.swamp_forest_pond");
	...
	{
		local tile1 = this.MapGen.get("tactical.tile.swampforest1");
		local tile2 = this.MapGen.get("tactical.tile.swampforest2");
		local tile3 = this.MapGen.get("tactical.tile.swampforest3");
