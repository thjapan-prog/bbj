this.swampgreen1 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
			"swamp_grass_green_03",
			"swamp_grass_green_04",
			"swamp_grass_green_05",
			"detail_mushrooms_01",
			"detail_mushrooms_02",
			"detail_swamp_01",
			"detail_swamp_02",
			...
			"swamp_moss_green_05",
			"swamp_moss_green_06",
			"swamp_puddle_green_02",
			"swamp_puddle_green_03",
			"swamp_puddle_green_04",
			"swamp_puddle_green_05",
			"swamp_puddle_green_06",
			"swamp_puddle_green_07",
			"swamp_grass_green_06",
			"swamp_grass_green_08"
		],
		DetailsAlt = [
			"swamp_grass_green_01"
		],
		HidingFront = "hiding_swamp_green_01_front",
		HidingBack = "hiding_swamp_green_01_back",
		HidingExtras = [
			"swamp_grass_green_06",
			"swamp_grass_green_07",
			"swamp_grass_green_08",
			"swamp_grass_green_09",
			"swamp_grass_green_10",
			"swamp_grass_green_11",
			"swamp_grass_green_12"
		],
	...
	function init()
	{
		this.m.Name = "tactical.tile.swampgreen1";
		this.m.MinX = 1;
		this.m.MinY = 1;
		...
		this.Tactical.setTransitions("tile_swamp_green_01", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Swampgreen1;
		tile.IsBadTerrain = false;
		tile.setBrush("tile_swamp_green_01");
		local n = 0;
