this.swampgreen5 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
		...
		ChanceToSpawnObject = 21
	},
	function init()
	{
		this.m.Name = "tactical.tile.swampgreen5";
		this.m.MinX = 1;
		this.m.MinY = 1;
		...
		this.Tactical.setTransitions("tile_swamp_green_05", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.setBrush("tile_swamp_green_05");
		local n = 0;
