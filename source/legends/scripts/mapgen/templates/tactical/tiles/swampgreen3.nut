this.swampgreen3 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
	...
	function init()
	{
		this.m.Name = "tactical.tile.swampgreen3";
		this.m.MinX = 1;
		this.m.MinY = 1;
		...
		this.Tactical.setTransitions("tile_swamp_green_03", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.setBrush("tile_swamp_green_03");
		local n = 0;
