this.legend_hunting_basilisks_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
	...
	{
		local contract = this.new("scripts/contracts/contracts/legend_hunting_basilisks_contract");
