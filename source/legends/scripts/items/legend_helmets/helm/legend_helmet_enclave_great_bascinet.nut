this.legend_helmet_enclave_great_bascinet <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.ArmorDescription = "Includes a great bascinet.";
	...
	function updateVariant()
	{
		...
		this.m.Sprite = "legendhelms_enclave_great_bascinet_" + variant;
		this.m.SpriteDamaged = "legendhelms_enclave_great_bascinet_" + variant + "_damaged";
		this.m.SpriteCorpse = "legendhelms_enclave_great_bascinet_" + variant + "_dead";
		this.m.Icon = "legend_helmets/inventory_enclave_great_bascinet_" + variant + ".png";
