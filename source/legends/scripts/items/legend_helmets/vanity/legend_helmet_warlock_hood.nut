this.legend_helmet_warlock_hood <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Warlock's Hood";
		this.m.Description = "A tattered hood of discolored fabric. Counts as a cultist item.";
		this.m.ArmorDescription = "Includes a tattered hood.";
