this.pov_autopsy_lindwurm_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.pov_autopsy_lindwurm_item";
		this.m.Name = "Lindwurm Autopsy";
		this.m.Description = "Attempt to extract useful items from this lindwurm corpse.";
		this.m.IconLarge = "";
		this.m.Icon = "consumables/pov_autopsy_lindwurm.png";
		this.m.Value = 300;
	}
