this.pov_autopsy_unhold3_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.pov_autopsy_unhold3_item";
		this.m.Name = "Swamp Unhold Autopsy";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/pov_autopsy_unhold3.png";
		this.m.Value = 300;
	}
	...
	function getTooltip()
	{
		...
		result.push({
			...
			type = "text",
			icon = "ui/icons/special.png",
			text = "Acquire [color=" + this.Const.UI.Color.PositiveValue + "]1[/color] unhold hide.\n[color=" + this.Const.UI.Color.PositiveValue + "]40%[/color] chance."
		});
		result.push({
			id = 11,
			type = "text",
