this.pov_named_schrat_shield <- ::inherit("scripts/items/shields/named/named_shield", {
	m = {},
	function create()
	{
		...
		this.m.Variant = 1;
		this.updateVariant();
		this.m.ID = "shield.pov_named_schrat";
	...
	{
		return ::MSU.Array.rand(::Const.Strings.PovSchratNames);
	}
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "shields/pov_inventory_named_schrat_shield_0" + this.m.Variant + ".png";
		this.m.Icon = "shields/pov_icon_named_schrat_shield_0" + this.m.Variant + ".png";
	}
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "Takes [color=" + ::Const.UI.Color.PositiveValue + "]20%[/color] less damage from piercing attacks."
		});
