this.pov_possessed_arbalester <- this.inherit("scripts/entity/tactical/humans/noble_arbalester", {
	m = {},
	function create()
	{
		this.noble_arbalester.create();
		this.m.Type = this.Const.EntityType.PossessedArbalester;
		this.m.Name = "Possessed Arbalester";
		this.m.XP += 40;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.noble_arbalester.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
