this.pov_possessed_greatsword <- this.inherit("scripts/entity/tactical/humans/noble_greatsword", {
	m = {},
	function create()
	{
		this.noble_greatsword.create();
		this.m.Type = this.Const.EntityType.PossessedGreatsword;
		this.m.Name = "Possessed Greatsword";
		this.m.XP += 70;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.noble_greatsword.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
