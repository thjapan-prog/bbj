this.pov_possessed_footman <- this.inherit("scripts/entity/tactical/humans/noble_footman", {
	m = {},
	function create()
	{
		this.noble_footman.create();
		this.m.Type = this.Const.EntityType.PossessedFootman;
		this.m.Name = "Possessed Footman";
		this.m.XP += 40;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.noble_footman.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
