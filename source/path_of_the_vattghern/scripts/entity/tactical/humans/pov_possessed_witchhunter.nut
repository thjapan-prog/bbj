this.pov_possessed_witchhunter <- this.inherit("scripts/entity/tactical/humans/legend_peasant_witchhunter", {
	m = {},
	function create()
	{
		this.legend_peasant_witchhunter.create();
		this.m.Type = this.Const.EntityType.PossessedWitchhunter;
		this.m.Name = "Possessed Witch Hunter";
		this.m.XP += 60;
	...
	function onInit()
	{
		this.legend_peasant_witchhunter.onInit();
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.legend_peasant_witchhunter.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
