this.pov_possessed_mercenary <- this.inherit("scripts/entity/tactical/humans/mercenary", {
	m = {},
	function create()
	{
		this.mercenary.create();
		this.m.Type = this.Const.EntityType.PossessedMercenary;
		this.m.Name = "Possessed Mercenary";
		this.m.XP += 60;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.mercenary.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
