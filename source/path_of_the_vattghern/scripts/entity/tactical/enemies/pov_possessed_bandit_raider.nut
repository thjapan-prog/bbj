this.pov_possessed_bandit_raider <- this.inherit("scripts/entity/tactical/enemies/legend_bandit_raider", {
	m = {},
	function create()
	{
		this.legend_bandit_raider.create();
		this.m.Type = this.Const.EntityType.PossessedBanditRaider;
		this.m.Name = "Possessed Bandit Raider";
		this.m.XP += 30;
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		...
		this.legend_bandit_raider.onDeath(_killer, _skill, _tile, _fatalityType);
	}
});
