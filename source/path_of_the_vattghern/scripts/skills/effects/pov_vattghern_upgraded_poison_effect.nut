this.pov_vattghern_upgraded_poison_effect <- this.inherit("scripts/skills/skill", {
	m = {
		TurnsLeft = 3,
		Damage = 15,
		LastRoundApplied = 0
	...
	function create()
	{
		this.m.ID = "effects.pov_vattghern_upgraded_poison";
		this.m.Name = "Vattghern Super Poison";
