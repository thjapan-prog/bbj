this.pov_vattghern_poison_effect <- this.inherit("scripts/skills/skill", {
	m = {
		TurnsLeft = 2,
		Damage = 9,
		LastRoundApplied = 0
	...
	function create()
	{
		this.m.ID = "effects.pov_vattghern_poison";
		this.m.Name = "Vattghern Poison";
