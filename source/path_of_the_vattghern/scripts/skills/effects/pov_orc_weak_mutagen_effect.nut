	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "Does [color=" + this.Const.UI.Color.PositiveValue + "]+6%[/color] overall damage."
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/ranged_defense.png",
				text = "Loses [color=" + this.Const.UI.Color.NegativeValue + "]20%[/color] plus flat [color=" + this.Const.UI.Color.NegativeValue + "]8[/color] Ranged Defense."
			},
			{
				id = 11,
				type = "text",
