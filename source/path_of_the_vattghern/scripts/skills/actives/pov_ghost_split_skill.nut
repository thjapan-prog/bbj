this.pov_ghost_split_skill <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		...
		this.m.Overlay = "pov_active_ghost_split";
		this.m.SoundOnUse = [
			"sounds/combat/pov_ghost_split_01.wav",
			"sounds/combat/pov_ghost_split_02.wav",
			"sounds/combat/pov_ghost_split_03.wav"
		];
		this.m.SoundOnHit = [
			"sounds/combat/pov_ghost_split_hit_01.wav",
			"sounds/combat/pov_ghost_split_hit_02.wav",
			"sounds/combat/pov_ghost_split_hit_03.wav"
		];
	...
	function onAnySkillUsed( _skill, _targetEntity, _properties )
	{
		if (_skill == this)
		{
			...
			// Skill Stats
			_properties.DamageRegularMin += 42;
