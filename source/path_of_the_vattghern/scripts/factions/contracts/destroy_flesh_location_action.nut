this.destroy_flesh_location_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
		this.m.ID = "destroy_flesh_location_action";
		this.m.Cooldown = this.World.getTime().SecondsPerDay * 26;
	...
	{
		local contract = this.new("scripts/contracts/contracts/destroy_flesh_location_contract");
