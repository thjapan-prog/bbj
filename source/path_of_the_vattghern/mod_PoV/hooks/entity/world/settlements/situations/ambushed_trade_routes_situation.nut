::TLW.HooksMod.hook("scripts/entity/world/settlements/situations/ambushed_trade_routes_situation", function(q) 
{
	q.getTooltip = @(__original) function()
	{
		...
		if(::TLW.PovSituation)
		{
			...
			ret.push({
				...
				text = "The following backgrounds are added to the recruit pool: [color=" + this.Const.UI.Color.povPerkDarkOrange + "]Caravan Hands, Peddlers, Thieves[/color]"
			});
