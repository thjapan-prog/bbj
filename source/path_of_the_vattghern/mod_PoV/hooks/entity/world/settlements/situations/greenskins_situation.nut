::TLW.HooksMod.hook("scripts/entity/world/settlements/situations/greenskins_situation", function(q) 
{
	q.getTooltip = @(__original) function()
	{
		...
		if(::TLW.PovSituation)
		{
			...
			ret.push({
				...
				type = "text",
				icon = "ui/icons/pov_situation_person.png",
				text = "The following backgrounds are added to the recruit pool: [color=" + this.Const.UI.Color.povPerkDarkOrange + "]Deserters, Sellswords, Hedge Knights[/color]"
			});
