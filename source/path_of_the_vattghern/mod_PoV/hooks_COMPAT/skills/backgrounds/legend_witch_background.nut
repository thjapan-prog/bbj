::TLW.HooksMod.hook("scripts/skills/backgrounds/legend_witch_background", function(q)
{
		...
		ret.push(
			{
				...
				text = "Experience gain increased by [color=" + this.Const.UI.Color.NegativeValue + "]10%[/color]."
			}
		);
		return ret;
	}
