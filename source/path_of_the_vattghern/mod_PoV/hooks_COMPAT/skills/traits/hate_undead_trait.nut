::TLW.HooksMod.hook("scripts/skills/traits/hate_undead_trait", function(q)
{
	q.getTooltip = @(__original) function()
	{
		return [
			...
			},
			{
				...
				text = "[color=%positive%]+10[/color] Resolve when in a battle against undead"
			},
			{
				id = 10,
				type = "text",
				icon = "ui/icons/melee_skill.png",
				text = "[color=%positive%]+5%[/color] Melee Skill when in a battle against undead"
			},
			{
				id = 10,
				type = "text",
				icon = "ui/icons/ranged_skill.png",
				text = "[color=%positive%]+5%[/color] Ranged Skill when in a battle against undead"
			},
			{
				id = 10,
				type = "text",
				icon = "ui/icons/damage_dealt.png",
				text = "[color=%positive%]+5%[/color] Damage when in battle with undead"
			}
		];
	}
