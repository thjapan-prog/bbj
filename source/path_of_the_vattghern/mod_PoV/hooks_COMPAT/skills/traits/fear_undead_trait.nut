::TLW.HooksMod.hook("scripts/skills/traits/fear_undead_trait", function(q)
{
	q.getTooltip = @(__original) function()
	{
		return [
			...
			},
			{
				...
				text = "[color=%negative%]-10[/color] Resolve when in battle with undead"
			},
			{
				id = 10,
				type = "text",
			...
			},
			{
				...
				text = "[color=%negative%]-5%[/color] Damage when in battle with undead"
			}
		];
	}
