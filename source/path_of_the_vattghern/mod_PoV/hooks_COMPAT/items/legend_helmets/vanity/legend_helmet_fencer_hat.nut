::TLW.HooksMod.hook("scripts/items/legend_helmets/vanity/legend_helmet_fencer_hat", function (q) {
	...
	q.getTooltip = @(__original) function()
	{
		...
		result.push({
			...
			text = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] initiative."
		});
		result.push({
			id = 7,
			type = "text",
