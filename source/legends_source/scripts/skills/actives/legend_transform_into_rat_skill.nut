this.legend_transform_into_rat_skill <- this.inherit("scripts/skills/skill", {
	m = {
		IsSpent = false
	},
	function create()
	...
	function isUsable()
	{
		return !this.m.Container.hasSkill("effect.legend_transformed_rat") && this.skill.isUsable();
	}
	...
	function onUse( _user, _targetTile )
	{
		if (!this.m.IsSpent)
		{
			this.m.Container.add(this.new("scripts/skills/effects/legend_transformed_rat_effect"));
			this.m.IsSpent = true;
		}
	}
