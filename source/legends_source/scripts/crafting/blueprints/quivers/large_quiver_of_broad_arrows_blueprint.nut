this.large_quiver_of_broad_arrows_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
	...
	{
		_stash.add(this.new("scripts/items/ammo/legend_large_broad_head_arrows"));
