this.swampgreen2 <- this.inherit("scripts/mapgen/tactical_template", {
	m = {
		Details = [
	...
	function init()
	{
		this.m.Name = "tactical.tile.swampgreen2";
		this.m.MinX = 1;
		this.m.MinY = 1;
		...
		this.Tactical.setTransitions("tile_swamp_green_02", t);
	}
	...
	function onFirstPass( _rect )
	{
		...
		tile.BlendPriority = this.Const.Tactical.TileBlendPriority.Swampgreen2;
		tile.IsBadTerrain = false;
		tile.setBrush("tile_swamp_green_02");
		local n = 0;
