this.xxmob_mino <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M86;
	...
	function onInit()
	{
		...
		b.Bravery += 20;
		b.Initiative += 10;
		b.DamageRegularMin += 100;
		b.DamageRegularMax += 190;
		...
		body.setBrush("bust_mino_0" + this.Math.rand(1, 2));
		body.varySaturation(0.1);
		body.varyColor(0.1, 0.1, 0.1);
		local injury = this.addSprite("injury");
		injury.setBrush("bust_orc_02_body_bloodied_03");
		...
		this.m.Skills.add(this.new("scripts/skills/actives/ai_punch_mino"));
		local skilla = this.new("scripts/skills/actives/ai_revive");
