this.xxmob_syndicate <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M71;
	...
	function assignRandomEquipment()
	{
		...
		itt.m.StaminaModifier = -10;
		itt.m.Condition = 200;
		itt.m.ConditionMax = itt.m.Condition;
		this.m.Items.equip(itt);
		itt = this.new("scripts/items/helmets/named/wolf_helmet");
		itt.m.ShowOnCharacter = false;
		itt.m.StaminaModifier = 0;
		itt.m.Condition = 100;
		itt.m.ConditionMax = itt.m.Condition;
		this.m.Items.equip(itt);
		this.m.Items.equip(this.new("scripts/items/weapons/named/xx_mob_katar"));
	}
