this.xxsum_fiend <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M81;
		...
		this.m.SoundVolume[this.Const.Sound.ActorEvent.Move] = 0.8;
