this.xxmob_longbug <- this.inherit("scripts/entity/tactical/actor", {
	m = {	},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M87;
	...
	function onInit()
	{
		...
		body.setBrush("bust_longbug_0" + this.Math.rand(1, 2));
		body.Scale = 0.8;
		...
		injury.setBrush("bust_orc_03_body_injured");
		injury.Scale = 0.7;
		this.setSpriteOffset("injury", this.createVec(-10, 10));
		...
		local sk = this.new("scripts/skills/actives/ai_meleeshoot");
		sk.m.DirectDamageMult = 0.5;
