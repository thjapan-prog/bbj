this.xxmob_liger <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M53;
	...
	function onInit()
	{
		...
		body.setBrush("bust_liger_0" + this.Math.rand(1, 2));
