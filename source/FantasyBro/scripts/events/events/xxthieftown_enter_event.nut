			...
			Options = [
				{
					...
					function getResult( _event )
					{
						...
						for( local i = 0; i < 1; i = ++i )
						{
							...
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							unit = clone this.Const.World.Spawn.Troops.Warhound;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							unit = clone this.Const.World.Spawn.Troops.Wardog;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
						}
						...
						{
							unit = clone this.Const.World.Spawn.Troops.StandardBearer;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							...
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							unit = clone this.Const.World.Spawn.Troops.BanditRaiderLOW;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							unit = clone this.Const.World.Spawn.Troops.BanditMarksmanLOW;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
						...
						for( local i = 0; i < 1; i = ++i )
						{
							...
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
							unit = clone this.Const.World.Spawn.Troops.BanditThug;
							unit.Faction <- this.Const.Faction.Enemy;
							pp.Entities.push(unit);
