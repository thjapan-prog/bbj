this.xxpotion_of_oblivion_item <- this.inherit("scripts/items/item", {
	m = {},
	function create()
	{
		this.item.create();
		this.m.ID = "misc.xxpotion_of_oblivion";
		this.m.Name = "Lesser Potion of Oblivion";
		this.m.Description = "Anybody who drinks this is said to be able to relive his life, changing the decisions he made along the way. (The Gifted perk does not refund perk points.)";
