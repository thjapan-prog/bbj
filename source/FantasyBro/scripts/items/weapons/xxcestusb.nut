this.xxcestusb <- this.inherit("scripts/items/weapons/weapon", {
	m = {},
	function create()
	{
		this.weapon.create();
		this.m.ID = "weapon.xxcestusb";
		this.m.Name = "Cestus";
		...
		this.m.IconLarge = "xx_weapon_21_70x70.png";
		this.m.Icon = "xx_weapon_21.png";
		this.m.ArmamentIcon = "icon_xx_weapon_21";
		this.m.Value = 150;
