this.xxitem_ringbladeaa_skill <- this.inherit("scripts/skills/skill", {
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "When ranged skill is over 80 : Max damage increases by 40% of ranged skill (max : +50)"
		});
		return ret;
	}
	...
	function onAnySkillUsed( _skill, _targetEntity, _properties )
	{
		if (_skill == this)
		{
			local gg = this.getContainer().getActor().getCurrentProperties().getRangedSkill();
			if (gg >= 80)
			{
