this.ai_soaked_effect <- this.inherit("scripts/skills/skill", {
	m = {
		TurnsLeft = 2
	},
	function create()
	{
		this.m.ID = "effects.ai_soaked_effect";
		this.m.Name = "Soaked";
	...
	{
		return "This character is soaked. It will last for [color=" + this.Const.UI.Color.NegativeValue + "]" + this.m.TurnsLeft + "[/color] more turn(s).";
	}
	...
	function onRefresh()
	{
		...
		this.spawnIcon("status_effect_68", this.getContainer().getActor().getTile());
	}
