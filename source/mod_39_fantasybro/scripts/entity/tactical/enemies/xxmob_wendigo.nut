this.xxmob_wendigo <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M75;
	...
	function onInit()
	{
		...
		body.setBrush("bust_wolfking_0" + this.Math.rand(1, 2));
		...
		this.m.Skills.add(this.new("scripts/skills/actives/ai_frost_passive"));
	...
	function onTurnStart()
	{
		...
		foreach( i in actors )
		{
			foreach( a in i )
			{
				...
				if (a.getFaction() == this.actor.getFaction() && a.getMoraleState() < this.Const.MoraleState.Steady)
				{
					...
					{
						a.setMoraleState(this.Const.MoraleState.Wavering);
					}
				}
				else if (!a.isAlliedWith(this.actor) && mytile.getDistanceTo(a.getTile()) <= 2 && this.Math.rand(1, 100) <= 50)
				{
					a.checkMorale(-1, 0, this.Const.MoraleCheckType.MentalAttack, "status_effect_52");
				}
			}
		}
		if (mytile.IsVisibleForPlayer)
		{
			this.Tactical.spawnIconEffect("active_156", mytile, this.Const.Tactical.Settings.SkillIconOffsetX, this.Const.Tactical.Settings.SkillIconOffsetY, this.Const.Tactical.Settings.SkillIconScale, this.Const.Tactical.Settings.SkillIconFadeInDuration, this.Const.Tactical.Settings.SkillIconStayDuration, this.Const.Tactical.Settings.SkillIconFadeOutDuration, this.Const.Tactical.Settings.SkillIconMovement);
		}
	}
