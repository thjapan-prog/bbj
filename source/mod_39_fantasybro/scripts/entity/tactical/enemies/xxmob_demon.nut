this.xxmob_demon <- this.inherit("scripts/entity/tactical/human", {
	...
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M27;
	...
	function onInit()
	{
		...
		else
		{
			...
			head.setBrush(face[this.Math.rand(0, face.len() - 1)]);
			hair.setBrush("bust_demon_headskin_01");
			hair.Visible = true;
			this.getSprite("permanent_injury_5").Visible = false;
		}
	...
	function onTurnStart()
	{
		...
		this.m.BaseProperties.DamageRegularMax += 3;
	}
