this.xxmob_whitewolf <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M76;
	...
	function onInit()
	{
		...
		body.Scale = 0.94;
		this.setSpriteOffset("body", this.createVec(8, -4));
		local injury_body = this.addSprite("injury");
		injury_body.Visible = false;
		injury_body.setBrush("bust_direwolf_injured");
		injury_body.Scale = 0.74;
		this.setSpriteOffset("injury", this.createVec(-2, -4));
	...
	{
		if (this.actor.getMoraleState() < this.Const.MoraleState.Steady && this.Math.rand(1, 100) <= 35)
		{
