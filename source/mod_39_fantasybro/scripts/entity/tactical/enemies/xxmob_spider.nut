this.xxmob_spider <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		Size = 1.0,
		DistortTargetA = null,
	...
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M66;
	...
	function onInit()
	{
		...
		head.setBrush("bust_xxspider_head_51");
