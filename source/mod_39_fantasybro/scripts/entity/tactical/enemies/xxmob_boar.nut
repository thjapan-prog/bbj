this.xxmob_boar <- this.inherit("scripts/entity/tactical/actor", {
	m = {	},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M18;
		...
		this.m.SoundVolume[this.Const.Sound.ActorEvent.Death] = 1.2;
		this.m.SoundVolume[this.Const.Sound.ActorEvent.Flee] = 1.1;
		this.m.SoundVolume[this.Const.Sound.ActorEvent.Idle] = 1.2;
		this.m.SoundPitch = this.Math.rand(95, 105) * 0.01;
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/direwolf_agent");
		this.m.AIAgent.setActor(this);
		this.getFlags().add("fiend_minion");
		this.getFlags().add("razorboar");
	}
	...
	function onInit()
	{
		...
		body.setBrush("bust_boar_0" + this.Math.rand(1, 3));
		...
		this.m.Skills.add(this.new("scripts/skills/actives/ai_boar_passive"));
		local s = this.new("scripts/skills/actives/ai_punch");
		s.m.Overlay = "active_110";
		s.m.SoundOnUse = [
			"sounds/enemies/ghoul_claws_01.wav",
			"sounds/enemies/ghoul_claws_03.wav"
		];
		s.m.ActionPointCost = 5;
