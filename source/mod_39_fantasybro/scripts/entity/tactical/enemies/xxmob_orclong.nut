this.xxmob_orclong <- this.inherit("scripts/entity/tactical/actor", {
	m = {},
	function create()
	{
		this.m.Name = this.Const.Strings.FT.M60;
	...
	function onInit()
	{
		...
		this.getSprite("tattoo_head").Color = this.createColor("#4f4f4f");
