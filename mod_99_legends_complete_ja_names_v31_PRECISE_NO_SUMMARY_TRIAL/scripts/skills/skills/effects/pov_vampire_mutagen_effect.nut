	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "隣接した血を持つ敵に与えたヒットポイントダメージの[color=" + this.Const.UI.Color.PositiveValue + "]10%[/color]を回復する。回復量はヴァット・ゲーンの最大HPの[color=" + this.Const.UI.Color.NegativeValue + "]15%が上限[/color]。"
			},
			{
				id = 11,
				type = "text",
