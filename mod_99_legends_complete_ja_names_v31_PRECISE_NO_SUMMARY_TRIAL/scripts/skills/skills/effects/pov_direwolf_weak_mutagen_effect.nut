	...
	function getTooltip()
	{
		local ret = [
			...
			}
			{
				...
				text = "全ての攻撃が、与えたヒットポイントダメージの[color=" + this.Const.UI.Color.PositiveValue + "]15%[/color]に相当する[color=" + this.Const.UI.Color.PositiveValue + "]出血[/color]を与える可能性がある。"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/fatigue.png",
				text = "スキルの疲労コストが[color=" + this.Const.UI.Color.PositiveValue + "]10%[/color]減少する"
			},
			{
				id = 11,
				type = "text",
