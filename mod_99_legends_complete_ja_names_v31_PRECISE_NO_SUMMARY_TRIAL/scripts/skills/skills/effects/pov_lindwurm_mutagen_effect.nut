	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "装甲への有効性が[color=" + this.Const.UI.Color.PositiveValue + "]25%[/color]上昇し、追加でフラットボーナス[color=" + this.Const.UI.Color.PositiveValue + "]15[/color]が加算される"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				text = "このキャラクターの近接防御が[color=" + this.Const.UI.Color.NegativeValue + "]12% + 4[/color]低下する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/asset_money.png",
				text = "[color=" + this.Const.UI.Color.NegativeValue + "]+25[/color]% 日給増加"
			}
