	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.povTooltipBlue + "]第三の眼[/color]スキルを獲得し、追加で視野が[color=" + this.Const.UI.Color.PositiveValue + "]+2[/color]増加する"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/special.png",
				text = "遠隔攻撃に[color=" + this.Const.UI.Color.PositiveValue + "]40%[/color]の耐性を持つ"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				text = "疲労回復が[color=" + this.Const.UI.Color.NegativeValue + "]-1[/color]減少する。"
			}
