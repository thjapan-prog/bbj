	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "[color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color]のヒットポイントボーナスを持つ。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/melee_skill.png",
				text = "近接攻撃が[color=" + this.Const.UI.Color.PositiveValue + "]+5[/color]上昇する。"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				text = "炎ダメージを[color=" + this.Const.UI.Color.NegativeValue + "]+80%[/color]多く受ける。"
			}
