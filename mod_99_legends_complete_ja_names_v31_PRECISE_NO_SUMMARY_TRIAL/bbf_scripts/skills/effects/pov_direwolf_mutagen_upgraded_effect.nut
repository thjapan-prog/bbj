	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "全ての攻撃が、与えたダメージの[color=" + this.Const.UI.Color.PositiveValue + "]30%[/color]に相当する[color=" + this.Const.UI.Color.PositiveValue + "]出血[/color]を与える可能性がある。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/fatigue.png",
				text = "移動の疲労コストが[color=" + this.Const.UI.Color.PositiveValue + "]75%[/color]減少する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/fatigue.png",
				text = "スキルの疲労コストが[color=" + this.Const.UI.Color.PositiveValue + "]30%[/color]減少する"
			},
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/special.png",
				text = "装甲着用による疲労とイニシアチブのペナルティが[color=" + this.Const.UI.Color.NegativeValue + "]20%[/color]増加する。"
			},
		];
		return ret;
	}
