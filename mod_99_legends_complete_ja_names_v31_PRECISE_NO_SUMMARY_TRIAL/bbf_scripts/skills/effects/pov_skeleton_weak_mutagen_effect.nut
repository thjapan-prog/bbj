	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "このキャラクターの食料消費が[color=" + this.Const.UI.Color.PositiveValue + "]50%[/color]減少する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/direct_damage.png",
				text = "このキャラクターは刺突ダメージに[color=" + this.Const.UI.Color.PositiveValue + "]30%[/color]の耐性を持つ。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/bravery.png",
				text = "全ての士気チェックに+[color=" + this.Const.UI.Color.PositiveValue + "]15[/color]のボーナスが適用される。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/days_wounded.png",
				text = "このキャラクターの失ったヒットポイントの回復が[color=" + this.Const.UI.Color.NegativeValue + "]40%[/color]遅くなる。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/pov_fire.png",
				text = "このキャラクターは炎攻撃から[color=" + this.Const.UI.Color.NegativeValue + "]75%[/color]多くダメージを受ける。"
			},
			{
				id = 11,
				type = "text",
