	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "近接防御が[color=" + this.Const.UI.Color.NegativeValue + "]10% + 5[/color]低下する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/melee_skill.png",
				text = "近接技量が+[color=" + this.Const.UI.Color.PositiveValue + "]10% + 8[/color]、近接ダメージが+[color=" + this.Const.UI.Color.PositiveValue + "]10%[/color]増加する。"
			}
