this.pov_mutant_poison_effect <- this.inherit("scripts/skills/skill", {
	m = {
		TurnsLeft = 2,
		Damage = 9,
		LastRoundApplied = 0
	...
	function create()
	{
		this.m.ID = "effects.pov_mutant_poison";
		this.m.Name = "変異体の毒！";
	...
	function onUpdate( _properties )
	{
		...
		_properties.MeleeDamageMult *= 0.88;
