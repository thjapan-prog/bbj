	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				text = "全体のダメージが[color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color]増加する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/ranged_defense.png",
				text = "遠隔防御が[color=" + this.Const.UI.Color.NegativeValue + "]15%[/color]に加えてフラット[color=" + this.Const.UI.Color.NegativeValue + "]7[/color]低下する。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/melee_defense.png",
				text = "周囲の敵1体につき近接防御が[color=" + this.Const.UI.Color.NegativeValue + "]-4[/color]低下する。"
			}
		];
