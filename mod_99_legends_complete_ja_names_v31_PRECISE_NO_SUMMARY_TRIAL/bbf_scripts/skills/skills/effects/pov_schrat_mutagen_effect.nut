	...
	function getTooltip()
	{
		local ret = [
			...
			},
			{
				...
				type = "text",
				icon = "ui/icons/special.png",
				text = "最大HPの[color=" + this.Const.UI.Color.PositiveValue + "]5%[/color]を超えるダメージを受けた場合、空きマスがあれば[color=" + this.Const.UI.Color.PositiveValue + "]苗木を生成する[/color]。[color=" + this.Const.UI.Color.NegativeValue + "]1戦闘中4回[/color]まで。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/armor_body.png",
				text = "このキャラクターの皮膚は硬く、[color=" + this.Const.UI.Color.PositiveValue + "]25[/color]ポイントの天然装甲を付与する"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/shield_damage.png",
				text = "盾を装備している時、全防御に[color=" + this.Const.UI.Color.PositiveValue + "]+10[/color]、ダメージ軽減に[color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color]のボーナスを得る。"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/damage_dealt.png",
				text = "盾による攻撃のダメージが[color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color]増加する。"
			},
			{
				id = 11,
				type = "text",
